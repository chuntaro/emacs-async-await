...
;;
;; (start-process "emacs" nil (file-truename (expand-file-name invocation-name invocation-directory)) "-Q" "--execute" "(package-initialize)" "-L" (concat default-directory "../") "-L" default-directory "-l" (file-name-base (buffer-file-name)) "--execute" "(launcher)")
